...
__decorate([
    (0, common_1.Patch)('todo/add/:id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, create_todo_dto_1.CreateTodoDto]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "todo_add", null);
__decorate([
    (0, common_1.Patch)('todo/update/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "todo_update", null);
__decorate([
    (0, common_1.Delete)('todo/delete/:id'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "todo_delete", null);
